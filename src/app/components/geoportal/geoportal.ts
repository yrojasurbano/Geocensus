...
const INDICATOR_CATEGORIES: IndicatorCategory[] = [
    {
        ...
        themes: [
            ...
            },
            {
                ...
                label: 'FECUNDIDAD',
                indicators: [
                    { key: 'mef_censadas',         label: 'Mujeres entre 15 y 49 años (mujeres en edad fértil censadas)' },
                    { key: 'prom_hijos_15_49',     label: 'Promedio de hijos/as nacidos/as vivos para mujeres censadas entre 15 y 49 años' },
                    { key: 'pct_mujeres_con_hijos',label: 'Porcentaje de mujeres censadas entre 15 y 49 años con hijos/as' },
                    { key: 'pct_mujeres_sin_hijos',label: 'Porcentaje de mujeres censadas entre 15 y 49 años sin hijos/as' },
                    { key: 'razon_nino_mujer',     label: 'Razón niño/a - mujer' },
                    { key: 'ms_12_mas_nocasadas',label: 'Madres solteras de 12 y más años (nunca casadas o nunca convivientes)' },
                    { key: 'ms_12_mas_adol',label: 'Madres adolescentes de 12 a 17 años' },
                ],
            },
            {
                key: 'migracion',
                label: 'INMIGRACIÓN EXTRANJERA',
                indicators: [
                    ...
                    { key: 'inmigrante_extranjera',              label: 'Población censada inmigrante extranjera' },
                    { key: 'razon_hombre_mujer_inmigrante',      label: 'Razón hombre - mujer de la población censada inmigrante extranjera' },
                    { key: 'edad_promedio_inmigrante',           label: 'Edad promedio de la población censada inmigrante extranjera' },
                    { key: 'edad_mediana_inmigrante',            label: 'Edad mediana de la población censada inmigrante extranjera' },
                    { key: 'indice_envejecimiento_inmigrante',   label: 'Índice de envejecimiento de la población censada inmigrante extranjera' },
                    { key: 'seguro_salud_inmigrante',            label: 'Población censada inmigrante extranjera con cobertura de seguro de salud' }, 
            ...
            },
            {
                ...
                indicators: [
                    { key: 'pob_12_unida',         label: 'Población censada de 12 y más años anteriormente unida' },
                    { key: 'pob_anterior_unida',   label: 'Población censada anteriormente unida' },
                    { key: 'pob_soltera',          label: 'Población censada de 12 y más años soltera' },
                    { key: 'pob_con_dni',          label: 'Población censada con DNI' },
                    { key: 'inmigrante_con_doc',   label: 'Población censada inmigrante extranjera con documento de identidad' },
            ...
            },
            {
                ...
                label: 'EDUCACIÓN',
                indicators: [
                    { key: 'tasa_asistencia',      label: 'Tasa de asistencia escolar de la población censada de 3 a 24 años' },                    
                    { key: 'asiste_fuera',         label: 'Población censada que se desplaza fuera de su distrito para asistir a su centro de enseñanza' },
                    { key: 'secundaria_completa',  label: 'Población censada de 15 y más años con secundaria completa u otro nivel mayor alcanzado' },
                    { key: 'tasa_alfabetismo',     label: 'Tasa de alfabetismo de la población censada de 15 y más años' },
                    { key: 'uso_tic',              label: "Población censada de 3 y más años de edad que utilizó dispositivos TIC's"},
                    { key: 'uso_internet',         label: 'Población censada de 3 y más años de edad que utilizó internet' },
                ],
            },
            {
                key: 'discapacidad',
                label: 'DISCAPACIDAD',
                indicators: [
                    { key: 'pob_discapacidad',     label: 'Población censada de 5 y más años con discapacidad' },
                    { key: 'disc_0_14',            label: 'Población censada con discapacidad de 5 a 14 años' },
                    { key: 'disc_15_59',           label: 'Población censada con discapacidad de 15 a 59 años' },
                    { key: 'disc_60_mas',          label: 'Población censada con discapacidad de 60 y más años' },
                    { key: 'disc_ver',             label: 'Población censada con discapacidad para ver' },
                    { key: 'disc_oir',             label: 'Población censada con discapacidad para oír' },
                    { key: 'disc_comunicarse',     label: 'Población censada con discapacidad para comunicarse' },
                    { key: 'disc_caminar',         label: 'Población censada con discapacidad para caminar' },
                    { key: 'disc_cuidado',         label: 'Población censada con discapacidad para el cuidado personal' },
                    { key: 'disc_concentrarse',    label: 'Población censada con discapacidad para concentrarse' },
                    { key: 'disc_relacionarse',    label: 'Población censada con discapacidad para relacionarse con los demás' },
                    { key: 'hogares_disc',         label: 'Porcentaje de hogares con al menos una persona con discapacidad' },
                    { key: 'seg_salud_discapacidad',      label: 'Población censada con discapacidad con cobertura de seguro de salud' },
                    { key: 'asiste_ensenanza_discap',     label: 'Población censada con discapacidad de 5 a 24 años que asiste a un centro de enseñanza' },
                    { key: 'analfabeta_discapacidad',     label: 'Población censada con discapacidad que no sabe leer ni escribir' },
                    { key: 'uso_tic_discapacidad',        label: "Población censada con discapacidad que hace uso de TIC's" },
                ],
            },
            {
                key: 'etnicidad',
            ...
            },
            {
                ...
                indicators: [
                    ...
                    { key: 'pet',                      label: 'Población censada en edad de trabajar (población censada de 14 y más años)' },
                    { key: 'pet_seg_salud',            label: 'Población censada en edad de trabajar con cobertura de seguro de salud' },
                    { key: 'pet_discapacidad',         label: 'Población censada en edad de trabajar con discapacidad' },
                    { key: 'pet_analfabeta',           label: 'Población censada en edad de trabajar que no sabe leer ni escribir' },
                ],
            },
        ],
    },
        ...
        themes: [
            {
                ...
                indicators: [
                    ...
                    { key: 'viviendas_ocupadas',   label: 'Viviendas censadas ocupadas' },
                    { key: 'viviendas_desocupadas',label: 'Viviendas censadas desocupadas' },
                    { key: 'departamentos_edif',   label: 'Viviendas particulares con ocupantes presentes que son departamentos en edificio o en block de condominio' },
                    { key: 'viv_calidad_adecuada', label: 'Viviendas particulares con ocupantes presentes con calidad adecuada' },
                    { key: 'prom_habitaciones',    label: 'Promedio de habitaciones de las viviendas particulares con ocupantes presentes' },
                ],
            },
            {
                key: 'servicios_basicos',
                label: 'SERVICIOS BÁSICOS DE LA VIVIENDA',
                indicators: [
                    { key: 'acceso_agua',          label: 'Viviendas particulares con ocupantes presentes con abastecimiento de agua por red pública' },
                    { key: 'servicio_higienico',   label: 'Viviendas particulares con ocupantes presentes con servicio higiénico conectado a red pública' },
                    { key: 'energia_electrica',    label: 'Viviendas particulares con ocupantes presentes con suministro de energía eléctrica por red pública' },
                ],
            },
        ],
    },
        ...
        themes: [
            {
                ...
                indicators: [
                    ...
                    { key: 'prom_personas',        label: 'Promedio de personas por hogar' },
                    { key: 'hogares_unipersonales',label: 'Porcentaje de hogares unipersonales' },
                    { key: 'hogares_con_ninos',    label: 'Porcentaje de hogares con niños/as y/o adolescentes' },
                    { key: 'hogares_adulto_mayor', label: 'Porcentaje de hogares conformados solo por adultos mayores' },
                    { key: 'responsable_hombre',   label: 'Hogares con responsable de hogar hombre' },
                    { key: 'responsable_mujer',    label: 'Hogares con responsable de hogar mujer' },
                    { key: 'hogares_emigrante_intern',    label: 'Hogares con algún miembro en condición de emigrante internacional' },
                ],
            },
            {
                key: 'caracteristicas_hogar',
                label: 'CARACTERÍSTICAS DEL HOGAR',
                indicators: [
                   { key: 'hog_viv_propia',           label: 'Hogares con vivienda propia' },
                  { key: 'hog_comb_limpio',          label: 'Hogares que utilizan energía o combustible limpios para cocinar' },
                  { key: 'hog_resid_recolector_mun', label: 'Hogares que eliminan los residuos sólidos por recolector municipal' },
                  { key: 'hog_resid_recolector_inf', label: 'Hogares que eliminan los residuos sólidos por recolector informal' },
                  { key: 'hog_resid_quemado_forma', label: 'Hogares que eliminan los residuos sólidos al quemarlos, enterrarlos u otra forma' },
                ],
            },
            {
                key: 'equipamiento',
                ...
                indicators: [
                    { key: 'conexion_internet',    label: 'Hogares que tienen conexión a internet' },
                    { key: 'telefono_celular',     label: 'Hogares que tienen teléfono celular' },
                    { key: 'computadora',          label: 'Hogares que tienen computadora, laptop o tableta' },
                    { key: 'auto_camioneta',       label: 'Hogares que tienen auto o camioneta' },
                ],
            },
