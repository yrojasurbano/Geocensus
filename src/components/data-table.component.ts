            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex gap-2">
                    <input type="text" placeholder="Buscar departamento..."
                           class="bg-gray-100 text-xs px-2 py-1 rounded border border-gray-200 focus:outline-none focus:ring-1 focus:ring-rose-400 w-32">
                    <button class="bg-white border border-gray-200 text-gray-600 px-2 py-1 rounded text-xs hover:bg-gray-50">
                        Filtrar
                    </button>
                    <button class="bg-[#C2264B] text-white px-2 py-1 rounded text-xs hover:bg-[#A01E3C]">Exportar
                    </button>
                </div>
            </div>
