...
export class StatCardComponent {
    ...
    chartOptions = computed<EChartsOption>(() => {
        ...
        // Definimos el objeto con "as EChartsOption" para evitar inferencias genéricas
        return {
            animation: true,
            ...
            xAxis: {
                type: 'category' as const, // <-- IMPORTANTE: as const soluciona el error
                ...
                axisLabel: {
                    ...
                    overflow: 'truncate' as const, // <-- También aquí por precaución
                    width: 40,
                },
                axisLine: {show: false},
                axisTick: {show: false},
            ...
            yAxis: {
                type: 'value' as const, // <-- IMPORTANTE: as const
                show: false,
            },
            series: [
                {
                    type: 'bar' as const, // <-- IMPORTANTE: as const
                    barMaxWidth: 20,
                    barMinWidth: 4,
                    data: data.map(d => ({
                        value: d.value,
        ...
        } as EChartsOption; // Forzamos el tipo al final para asegurar compatibilidad total
    });
}
